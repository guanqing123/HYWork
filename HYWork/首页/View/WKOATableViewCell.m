...
@interface WKOATableViewCell() <UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation WKOATableViewCell
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.homeWork = _oaWorks[indexPath.row];
