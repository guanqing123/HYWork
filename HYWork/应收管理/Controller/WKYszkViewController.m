//
//  WKYszkViewController.m
//  HYWork
//
//  Created by information on 2020/3/12.
//  Copyright © 2020 hongyan. All rights reserved.
//

#import "WKYszkViewController.h"
#import "LoadViewController.h"
#import <WebKit/WebKit.h>

@interface WKYszkViewController ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, weak)  WKWebView *webView;
@end

@implementation WKYszkViewController
...
//    }
    ...
    NSString *urlPath = [NSString stringWithFormat:@"http://dev.sge.cn/hyyszk/index.html?ygbm=%@",userid];
