...
@interface WKGckhViewController ()<WKNavigationDelegate,WKUIDelegate>
...
@implementation WKGckhViewController
...
/** 设置 webView */
- (void)setupWebView {
    NSString *url = [NSString stringWithFormat:@"http://sge.cn:9106/app/web/crmShowGcxm?id=%@&ywy=%@",_xh,_ywy];
