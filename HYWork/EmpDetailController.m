...
@interface EmpDetailController () <UITableViewDataSource,UITableViewDelegate>
...
@implementation EmpDetailController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    lineView.frame = CGRectMake(0, [TxlCell getCellHeight] - 1, SCREEN_WIDTH, 1);
