...
@interface NoticePushViewController ()<WKNavigationDelegate,WKUIDelegate>
...
@implementation NoticePushViewController
...
- (void)setWebView {
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:_urlPath]]];
