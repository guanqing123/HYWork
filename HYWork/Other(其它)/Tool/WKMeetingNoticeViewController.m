//
//  WKMeetingNoticeViewController.m
//  HYWork
//
//  Created by information on 2019/8/20.
...
@interface WKMeetingNoticeViewController ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, weak)  WKWebView *webView;
@property (nonatomic, copy) NSString *urlPath;
@end

@implementation WKMeetingNoticeViewController
