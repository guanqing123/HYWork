...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    static NSString *ID = @"BrowseCell";
    BrowseCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[BrowseCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}
