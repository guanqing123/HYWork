...
@property (strong, nonatomic) UIViewController<SubLBXScanViewControllerDelegate> *viewController;
@end
...
- (void)ShowSelectedType:(ScanStyle)type WithViewController:(UIViewController<SubLBXScanViewControllerDelegate> *)vc {
