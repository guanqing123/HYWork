...
- (void)drawBottomItems
{
    ...
    // CGRectGetWidth(_bottomItemsView.frame)/2
...
- (void)scanResultWithArray:(NSArray<LBXScanResult*>*)array
{
    ...
    if ([self.delegate respondsToSelector:@selector(subLBXScanViewController:resultStr:)]) {
        [self.delegate subLBXScanViewController:self resultStr:strResult];
    }
    [self.navigationController popViewControllerAnimated:YES];
