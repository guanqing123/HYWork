...
- (void)datePickerValueChanged:(UIDatePicker *)datePicker {
    ...
    self.selectedTime = [dateFormater stringFromDate:selected];
}
...
- (void)itemClick:(UIButton *)button {
    ...
    [dateFormater setDateFormat:@"HH:mm"];
    self.selectedTime = [dateFormater stringFromDate:selected];
    if ([self.delegate respondsToSelector:@selector(didFinishTimePicker:buttonType:)]) {
        [self.delegate didFinishTimePicker:self.selectedTime buttonType:(int)button.tag];
    }
}
