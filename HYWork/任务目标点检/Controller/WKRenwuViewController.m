...
@interface WKRenwuViewController () <WKUIDelegate, WKNavigationDelegate>
...
@implementation WKRenwuViewController
...
//    webView.frame = CGRectMake(0, KJTopNavH, ScreenW, ScreenH - KJTopNavH);
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:RenWuURL, loadVC.emp.ygbm]]]];
